...
{
	int mask = (int)(temperature * TEMPERATURE_TO_MASK_RATIO);
	max31856_write_register(max31856, MAX31856_LTLFTH, mask >> 8);
	max31856_write_register(max31856, MAX31856_LTLFTL, mask & 0xFF);
}
void max31856_setHighColdJunctionFaultTemp(max31856_t *max31856, float temperature)
{
	...
	max31856_write_register(max31856, MAX31856_CJHF, mask);
}
