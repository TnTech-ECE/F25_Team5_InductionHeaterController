...
**Wet/Dry Compartmentalization:** The enclosure will be segregated by a solid internal barrier to create two electrically isolated zones:
  - **Wet/Power Zone:** This area houses the water cooling loop, heating pipe, and induction coil connections. All connectors entering this zone will be watertight (IP-rated glands or compression fittings) to prevent fluid migration [10].
  - **Dry/Control Zone:** This area houses the low-voltage control PCB and sensing electronics. The water flow sensor cable will pass between zones only through a sealed grommet [10].
...
- **Heatsink Integration:** The IGBT heatsink will be mounted to the enclosure wall to use the entire aluminum chassis as a secondary heat sink [11]. This mounting requires two specific steps:
    1. **Preparation:** The heatsink base must be precisely drilled and tapped to secure the four IGBT modules.
